...
@AllArgsConstructor
@NoArgsConstructor
@ApiModel(value="ListDangerZoneSensorTraceRequest", description="위험지역기록 리스트 요청")
public class ListDangerZoneSensorTraceRequest extends DefaultPageRequest {

    @ApiModelProperty(notes = "검색 조건명. COMPLEX : 전체(건설사명 + 공사명 + 협력사명 + 근로자 아이디 + 근로자명), ccName : 건설사명, wpName : 공사명(현장명), coopMbName : 협력사명, mbId : 근로자 아이디, mbName : 근로자명")
