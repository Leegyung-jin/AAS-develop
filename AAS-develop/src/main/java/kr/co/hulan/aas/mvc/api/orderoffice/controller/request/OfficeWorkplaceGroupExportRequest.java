...
@AllArgsConstructor
@NoArgsConstructor
@ApiModel(value="OfficeWorkplaceGroupExportRequest", description="발주사 현장그룹 데이터 Export 요청")
public class OfficeWorkplaceGroupExportRequest extends ConditionRequest {
