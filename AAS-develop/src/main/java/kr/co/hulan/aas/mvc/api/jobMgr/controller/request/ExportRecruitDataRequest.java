...
@AllArgsConstructor
@NoArgsConstructor
@ApiModel(value="ExportRecruitDataRequest", description="구인 데이터 Export 요청")
public class ExportRecruitDataRequest extends ConditionRequest {

    @ApiModelProperty(notes = "검색 조건명. wpName : 공사명(현장명), coopMbName : 협력사명, rcTitle : 공고명 ")
