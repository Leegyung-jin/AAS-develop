...
@AllArgsConstructor
@NoArgsConstructor
@ApiModel(value="ExportSensorSituationByWorkPlaceDataRequest", description="현장별 센서 현황 데이터 Export 요청")
public class ExportSensorSituationByWorkPlaceDataRequest extends DefaultPageRequest {

    @ApiModelProperty(notes = "검색 조건명. wpName : 공사명(현장명)")
