...
@Data
public class ListWorkerSafetySituationRequest extends DefaultPageRequest {

    @ApiModelProperty(notes = "검색 조건명. COMPLEX : 전체(건설사명 + 현장명 + 협력사명 + 휴대폰번호 + 이름 + 근로자공정명 ), ccName:건설사명, wpName:현장명, coopMbName:협력사명, mbId:휴대폰번호, mbName : 이름, workSectionNameB: 근로자공정명")
    ...
    @ApiModelProperty(notes = "공종코드A")
    private String workSectionA;

    @ApiModelProperty(notes = "공종코드B")
