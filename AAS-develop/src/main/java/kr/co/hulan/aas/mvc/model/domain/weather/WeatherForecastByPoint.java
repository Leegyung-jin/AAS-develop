...
@Data
@Entity
@IdClass(WeatherForecastByPointKey.class)
@Table(name = "weather_forecast_by_point")
public class WeatherForecastByPoint {

  @Id
  @Basic
  @Column(name = "wfp_cd", columnDefinition="varchar(8)")
  ...
  @Basic
  @Column(name = "temperature_low", columnDefinition="varchar(16)")
  private String temperatureLow;
  @Basic
  @Column(name = "temperature_high", columnDefinition="varchar(16)")
