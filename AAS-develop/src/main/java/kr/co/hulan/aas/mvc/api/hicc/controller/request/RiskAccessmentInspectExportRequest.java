...
@AllArgsConstructor
@NoArgsConstructor
@ApiModel(value="RiskAccessmentInspectExportRequest", description="위험성 평가 데이터 Export 요청")
public class RiskAccessmentInspectExportRequest extends ConditionRequest {
