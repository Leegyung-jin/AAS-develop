...
@Data
@Entity
@Table(name = "alarm_check_policy_info")
public class AlarmCheckPolicyInfo {
    ...
    private String wpId;
    @Basic
    @Column(name = "work_check", columnDefinition="tinyint(4)")
    private Integer workCheck;
    @Basic
    @Column(name = "safe_check", columnDefinition="tinyint(4)")
