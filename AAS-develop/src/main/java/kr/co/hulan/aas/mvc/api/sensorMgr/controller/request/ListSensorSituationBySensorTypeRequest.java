...
@AllArgsConstructor
@NoArgsConstructor
@ApiModel(value="ListSensorSituationByDistrictRequest", description="센서타입별 센서 현황 리스트 요청")
public class ListSensorSituationBySensorTypeRequest extends DefaultPageRequest {
