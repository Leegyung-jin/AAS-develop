...
@AllArgsConstructor
@NoArgsConstructor
@ApiModel(value="ListSensorSituationByDistrictRequest", description="구역별 센서 현황 리스트 요청")
public class ListSensorSituationByDistrictRequest extends DefaultPageRequest {
