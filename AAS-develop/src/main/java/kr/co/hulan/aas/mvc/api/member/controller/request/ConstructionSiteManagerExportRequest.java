...
@AllArgsConstructor
@NoArgsConstructor
@ApiModel(value="ConstructionSiteManagerExportRequest", description="건설현장 매니저 데이터 Export 요청")
public class ConstructionSiteManagerExportRequest extends ConditionRequest {
