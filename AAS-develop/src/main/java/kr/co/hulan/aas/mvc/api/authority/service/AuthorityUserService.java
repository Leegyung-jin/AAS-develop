...
public class AuthorityUserService {
    ...
    public List<AuthorityUserDto> findListByCondition(Map<String,Object> conditionMap) {
        return authorityUserDao.findListByCondition(AuthenticationHelper.addAdditionalConditionByLevel(conditionMap));
    }

    private Integer countListByCondition(Map<String,Object> conditionMap) {
        return authorityUserDao.countListByCondition(AuthenticationHelper.addAdditionalConditionByLevel(conditionMap));
    }
