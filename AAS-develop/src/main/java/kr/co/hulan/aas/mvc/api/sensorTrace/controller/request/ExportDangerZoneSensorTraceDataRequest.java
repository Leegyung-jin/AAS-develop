...
@AllArgsConstructor
@NoArgsConstructor
@ApiModel(value="ExportDangerZoneSensorTraceDataRequest", description="위험지역기록 데이터 Export 요청")
public class ExportDangerZoneSensorTraceDataRequest extends ConditionRequest {
