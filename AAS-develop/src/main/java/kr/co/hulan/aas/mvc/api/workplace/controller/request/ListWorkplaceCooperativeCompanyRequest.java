...
@AllArgsConstructor
@NoArgsConstructor
@ApiModel(value="ListCooperativeCompanyMgrRequest", description="협력사 현장 편입 리스트 요청")
public class ListWorkplaceCooperativeCompanyRequest extends DefaultPageRequest {
