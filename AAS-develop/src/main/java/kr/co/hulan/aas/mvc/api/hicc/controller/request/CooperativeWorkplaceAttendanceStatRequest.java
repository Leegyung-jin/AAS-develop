...
@AllArgsConstructor
@NoArgsConstructor
@ApiModel(value="CooperativeWorkplaceAttendanceStatRequest", description="협력사 현장별 출역 현황 리스트(페이징) 요청")
public class CooperativeWorkplaceAttendanceStatRequest extends DefaultPageRequest  {
