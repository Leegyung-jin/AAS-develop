...
@AllArgsConstructor
@NoArgsConstructor
@ApiModel(value="ExportGpsCheckPolicyInfoDataRequest", description="GPS 정책 Data Export 요청")
public class ExportGpsCheckPolicyInfoDataRequest extends ConditionRequest {
