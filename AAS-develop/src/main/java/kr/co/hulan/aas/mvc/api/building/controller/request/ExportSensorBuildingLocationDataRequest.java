...
@AllArgsConstructor
@NoArgsConstructor
@ApiModel(value="ExportSensorBuildingLocationDataRequest", description="센서 빌딩 위치 정보  Data Export 요청")
public class ExportSensorBuildingLocationDataRequest extends ConditionRequest {
