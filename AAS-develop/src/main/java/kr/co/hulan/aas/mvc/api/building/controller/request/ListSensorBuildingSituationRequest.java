...
@AllArgsConstructor
@NoArgsConstructor
@ApiModel(value="ListSensorBuildingSituationRequest", description="센서 빌딩 위치 현황 정보 요청")
public class ListSensorBuildingSituationRequest extends DefaultPageRequest  {
