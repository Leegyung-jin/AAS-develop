...
@AllArgsConstructor
@NoArgsConstructor
@ApiModel(value="ListRecruitApplyRequest", description="구직 리스트 요청")
public class ListRecruitApplyRequest extends DefaultPageRequest {

    @ApiModelProperty(notes = "검색 조건명. COMPLEX : 전체(공사명 + 협력사명 + 공고명 + 연락처), wpName : 공사명(현장명), coopMbName : 협력사명, rcTitle : 공고명, mbId : 연락처 ")
