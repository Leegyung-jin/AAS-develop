...
@AllArgsConstructor
@NoArgsConstructor
@ApiModel(value="ExportSensorSituationBySensorTypeDataRequest", description="센서 타입별 데이터 Export 요청")
public class ExportSensorSituationBySensorTypeDataRequest extends DefaultPageRequest {
