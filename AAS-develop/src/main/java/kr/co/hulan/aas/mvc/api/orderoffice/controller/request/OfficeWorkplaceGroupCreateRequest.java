...
@AllArgsConstructor
@NoArgsConstructor
@ApiModel(value="OfficeWorkplaceGroupCreateRequest", description="발주사 현장그룹 등록 요청")
public class OfficeWorkplaceGroupCreateRequest {

  @NotNull(message = "발주사 관리번호는 필수입니다")
