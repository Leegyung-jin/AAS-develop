...
@AllArgsConstructor
@NoArgsConstructor
@ApiModel(value="ExportWorkDeviceInfoDataRequest", description="현장 디바이스 정보  Data Export 요청")
public class ExportWorkDeviceInfoDataRequest extends ConditionRequest {
