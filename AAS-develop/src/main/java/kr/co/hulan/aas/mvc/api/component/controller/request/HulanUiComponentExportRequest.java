...
@AllArgsConstructor
@NoArgsConstructor
@ApiModel(value="HulanUiComponentExportRequest", description="현장 모니터링 UI 컴포넌트 Data export 요청")
public class HulanUiComponentExportRequest extends ConditionRequest {
