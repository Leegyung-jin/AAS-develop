...
@AllArgsConstructor
@NoArgsConstructor
@ApiModel(value="ListEducationnonAttendeeSituationRequest", description="안전조회미참석자현황 검색 요청")
public class ListEducationnonAttendeeSituationRequest extends DefaultPageRequest {


    @ApiModelProperty(notes = "검색 조건명. COMPLEX : 전체(협력사명), coopMbName : 협럭사명")
