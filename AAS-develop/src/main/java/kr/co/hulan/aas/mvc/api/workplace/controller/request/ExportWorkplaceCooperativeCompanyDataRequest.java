...
@AllArgsConstructor
@NoArgsConstructor
@ApiModel(value="ListCooperativeCompanyMgrRequest", description="협력사 현장 편입 데이터 Export 요청")
public class ExportWorkplaceCooperativeCompanyDataRequest extends ConditionRequest {



    @ApiModelProperty(notes = "검색 조건명. coopMbName : 협력사명, wpcWork : 공종")
