...
@AllArgsConstructor
@NoArgsConstructor
@ApiModel(value="OfficeGroupManagerPagingListRequest", description="발주사 현장그룹 매니저 페이징 리스트 요청")
public class OfficeGroupManagerPagingListRequest extends DefaultPageRequest {
  ...
  @ApiModelProperty(notes = "발주사 현장그룹 관리번호")
  private Long wpGrpNo;

  @ApiModelProperty(notes = "제외 발주사 현장그룹 관리번호")
  private Long excludeWpGrpNo;
  ...
  public Map<String,Object> getConditionMap(){
    ...
    if(excludeWpGrpNo != null){
      condition.put("excludeWpGrpNo", excludeWpGrpNo);
    }
    if(wpGrpNo != null){
      condition.put("wpGrpNo", wpGrpNo);
    }
    if(startDate != null){
