...
@AllArgsConstructor
@NoArgsConstructor
@ApiModel(value="ExportSensorSituationByDistrictDataRequest", description="센서 구역 데이터 Export 요청")
public class ExportSensorSituationByDistrictDataRequest extends DefaultPageRequest {
