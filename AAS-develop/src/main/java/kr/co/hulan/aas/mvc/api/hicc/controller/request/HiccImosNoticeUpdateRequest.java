...
@AllArgsConstructor
@NoArgsConstructor
@ApiModel(value="HiccImosNoticeUpdateRequest", description="[통합관제] 현장 공지사항 수정 요청")
public class HiccImosNoticeUpdateRequest {
  ...
  private List<ImosNoticeWorkplaceDto> workplaceList;
   */
