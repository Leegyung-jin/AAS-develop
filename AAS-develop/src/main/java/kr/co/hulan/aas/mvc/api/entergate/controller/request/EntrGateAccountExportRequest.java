...
@AllArgsConstructor
@NoArgsConstructor
@ApiModel(value="EntrGateAccountExportRequest", description="출입게이트 업체 계정 정보 데이터 export 요청")
public class EntrGateAccountExportRequest extends ConditionRequest {
