...
@AllArgsConstructor
@NoArgsConstructor
@ApiModel(value="ImosMagneticOpeningPagingListRequest", description="개구부 센서 상태 정보 검색(페이징)")
public class ImosMagneticOpeningPagingListRequest extends DefaultPageRequest {
