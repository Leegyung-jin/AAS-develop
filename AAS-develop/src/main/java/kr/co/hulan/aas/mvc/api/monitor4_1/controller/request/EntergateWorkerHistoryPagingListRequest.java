...
@AllArgsConstructor
@NoArgsConstructor
@ApiModel(value="EntergateWorkerHistoryPagingListRequest", description="출입게이트 출근자 이력 검색(페이징)")
public class EntergateWorkerHistoryPagingListRequest extends DefaultPageRequest  {
