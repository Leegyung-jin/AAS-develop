...
@Data
public class ExportWorkerSafetySituationRequest extends ConditionRequest {

    @ApiModelProperty(notes = "검색 조건명. ccName:건설사명, wpName:현장명, coopMbName:협력사명, mbId:휴대폰번호")
