...
@AllArgsConstructor
@NoArgsConstructor
@ApiModel(value="ImosSafetyHookWorkerListResponse", description="IMOS 안전고리 협력사 근로자 리스트 응답")
public class ImosSafetyHookWorkerListResponse {
  ...
  @ApiModelProperty(notes = "근로자 정보 리스트")
  private List<ImosSafetyHookWorkerVo> coopStateList;
