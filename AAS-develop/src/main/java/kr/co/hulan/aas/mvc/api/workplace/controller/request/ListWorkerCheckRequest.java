...
@AllArgsConstructor
@NoArgsConstructor
@ApiModel(value="ListWorkerCheckRequest", description="고위험/주요근로자 리스트 요청")
public class ListWorkerCheckRequest extends DefaultPageRequest {


    @ApiModelProperty(notes = "검색 조건명. COMPLEX : 전체(건설사명 + 공사명 + 협력사명 + 근로자아이디 + 근로자성명 + 등록자아이디 + 등록자명), ccName : 건설사명, wpName : 공사명(현장명), coopMbName : 협력사명, workerMbId : 근로자 아이디, workerMbName : 근로자명, mbId : 등록자 아이디, mbName : 등록자명")
