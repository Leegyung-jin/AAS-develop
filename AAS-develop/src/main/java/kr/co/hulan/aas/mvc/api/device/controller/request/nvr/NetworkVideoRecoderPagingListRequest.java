...
@AllArgsConstructor
@NoArgsConstructor
@ApiModel(value="NetworkVideoRecoderExportRequest", description="NVR 리스트(페이징) 요청")
public class NetworkVideoRecoderPagingListRequest extends DefaultPageRequest {
