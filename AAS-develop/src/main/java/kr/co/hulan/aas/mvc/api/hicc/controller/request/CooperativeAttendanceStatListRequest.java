...
@AllArgsConstructor
@NoArgsConstructor
@ApiModel(value="CooperativeAttendanceStatListRequest", description="협력사 출역 현황 리스트 요청")
public class CooperativeAttendanceStatListRequest extends DefaultPageRequest {
