...
@AllArgsConstructor
@NoArgsConstructor
@ApiModel(value="ConCompanyManagerPagingListRequest", description="건설사 관리자 페이징 리스트 요청")
public class ConCompanyManagerPagingListRequest extends DefaultPageRequest {

  @ApiModelProperty(notes = "검색 조건명. COMPLEX : 전체, ccName : 건설사명명, mbName:성명,  mbId:회원아이디, telephone: 전화번호 ")
