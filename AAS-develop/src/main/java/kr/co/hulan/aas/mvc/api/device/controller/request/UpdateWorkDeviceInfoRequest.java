...
@AllArgsConstructor
@NoArgsConstructor
@ApiModel(value="UpdateWorkDeviceInfoRequest", description="현장 디바이스 정보 수정 요청")
public class UpdateWorkDeviceInfoRequest {

    @NotNull(message = "디바이스 번호는 필수입니다.")
    @ApiModelProperty(notes = "디바이스 번호", required = true)
    private Integer idx;
