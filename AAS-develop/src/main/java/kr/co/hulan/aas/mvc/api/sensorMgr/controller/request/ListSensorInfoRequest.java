...
@AllArgsConstructor
@NoArgsConstructor
@ApiModel(value="ListSensorInfoRequest", description="센서 정보 리스트 요청")
public class ListSensorInfoRequest extends DefaultPageRequest {


    @ApiModelProperty(notes = "검색 조건명. COMPLEX : 전체(공사명 + 안전센서번호 + 구역 + 위치1 + 위치2), wpName : 공사명(현장명), siCode : 안전센서번호, sdName : 구역, siPlace1 : 위치1, siPlace2 : 위치2")
    ...
    @ApiModelProperty(notes = "빌딩위치 등록여부. 0: 미등록, 1: 등록")
    private Integer isRegisterLocation;
    ...
    public Map<String,Object> getConditionMap(){
        ...
        if(isRegisterLocation != null){
            condition.put("isRegisterLocation", isRegisterLocation);
        }
        return condition;
    }
}
