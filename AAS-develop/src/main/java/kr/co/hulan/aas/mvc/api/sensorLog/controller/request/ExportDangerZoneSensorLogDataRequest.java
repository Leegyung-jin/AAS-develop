...
@AllArgsConstructor
@NoArgsConstructor
@ApiModel(value="ExportDangerZoneSensorLogDataRequest", description="위험 지역 접근 기록 데이터 Export 요청")
public class ExportDangerZoneSensorLogDataRequest extends ConditionRequest {
